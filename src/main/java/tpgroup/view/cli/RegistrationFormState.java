...
public class RegistrationFormState extends CliViewState {
	...
	public void present() {
		try {
			...
			System.out.println(
					"the password must have at least 8 characters, an upper and lowercase letter, a symbol and a number");
			...
			CliViewState nextState = authGCtrl.register(email, password, confPassword);
