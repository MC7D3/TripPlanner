...
public class SubmitUpdateProposal extends SelectEventFormState {

	protected SubmitUpdateProposal(CliView sm, FormData previousData) {
	...
	protected void handleChosenElement(Event chosen) {
		if(chosen != null){
			if(TripController.createUpdateProposal(formData.get("eventsNode"), chosen)){
